...
### CP-PREDUE-6 — 09 Aug 2026 — DEBT-034 + DEBT-035 latency fix round (TTS WS pre-open + opener LLM skip + boot pre-warm + ingress buffering)
- **Status:** [R] — DEBT-034 (fixes 1+2+3) + DEBT-035 (ingress buffering) implemented + unit-tested. Deploy + silent smoke + FINAL CALL 1-redux + CALL 2 pending (next).
